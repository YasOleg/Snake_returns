...
namespace Snake
{
    public partial class GameForm : Form
    {
        ...
        {
            int max_tile_w = pbCanvas.Size.Width / tileWidth;
            int max_tile_h = pbCanvas.Size.Height / tileHeight;
        ...
        private void UpdateSnake()
        {
            for (int i = snake.Count - 1; i >= 0; i--)
            {
                if (i == 0)
                {
                    ...
                    int max_tile_w = pbCanvas.Width / tileWidth;
                    int max_tile_h = pbCanvas.Height / tileHeight;
        ...
        private void pbCanvas_Paint(object sender, PaintEventArgs e)
        {
            ...
            else
            {
                ...
                canvas.FillRectangle(Brushes.Orange, new Rectangle(food_piece.X * tileWidth, food_piece.Y * tileHeight, tileWidth, tileHeight));
